...
const FooterToolsInitiator = {
  ...
  _generateSubscribeOptions() {
    return {
      // memberikan tanda secara resmi bahwa aplikasi web akan menampilkan pemberitahuan setiap kali push message diterima (terhindar dari silent push) dengan memberikan nilai true.
      userVisibleOnly: true,
      // merupakan data VAPID keys yang bersifat public sebagai bahan validasi oleh push service.
