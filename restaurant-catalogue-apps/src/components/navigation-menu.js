...
class NavigationMenu extends HTMLElement {
  ...
  _onBtnOpenClick() {
    this.dispatchEvent(new CustomEvent('btn-open-menu-click'));
  }

  _onBtnCloseClick() {
    this.dispatchEvent(new CustomEvent('btn-close-menu-click'));
  }
  ...
  render() {
    ...
    this._shadowRoot.innerHTML += `
      <nav class="topnav">
        ...
        <button role="button" id="btnOpen" class="topnav__btnOpen" aria-expanded="false" aria-labelledby="nav-label">
        ...
        <div class="topnav__menu" role="dialog" aria-labelledby="nav-label">
          <button role="button" class="topnav__btnClose" id="btnClose" aria-label="Close navigation menu">
          ...
          <ul aria-label="Main navigation" class="topnav__links">
            ...
            <li class="topnav__item">
              <a href="#/resto-list/detail/fe8bbxoazddkcowlqdz" class="topnav__link" aria-label="About Us">About Us</a>
            </li>
          </ul>
        </div>
      </nav>
